    ...
    try:
        conn.executescript(
            ...
            SELECT
              ...
              i.gt_last_resume_at,
              i.gt_no_op_counter,
              i.gt_no_op_summaries_json,
              i.gt_last_dispatch_fingerprint,
              i.follow_up_sop,
              i.stop_allowed,
              i.dispatch_target,
              i.dispatch_window,
            ...
            BEGIN
              INSERT OR REPLACE INTO instances (
                ...
                gt_last_resume_at, gt_no_op_counter, gt_no_op_summaries_json,
                gt_last_dispatch_fingerprint, follow_up_sop, stop_allowed, input_lock,
                ...
                NEW.gt_last_resume_at, COALESCE(NEW.gt_no_op_counter, 0), NEW.gt_no_op_summaries_json,
                NEW.gt_last_dispatch_fingerprint, NEW.follow_up_sop, COALESCE(NEW.stop_allowed, 1), NEW.input_lock,
            ...
            BEGIN
              UPDATE instances SET
                ...
                gt_no_op_counter = COALESCE(NEW.gt_no_op_counter, gt_no_op_counter),
                gt_no_op_summaries_json = NEW.gt_no_op_summaries_json,
                gt_last_dispatch_fingerprint = NEW.gt_last_dispatch_fingerprint,
