...
410 GONE: cli-tools/lib/tmux-state.sh (tmux-state.sh) is tombstoned by the 2026-06-30 tmux CLI exterminatus.
This cold tmux feature surface must not be used as an active runtime/control path.
Daemon-native replacement: tmuxctld GET /inspect/workspace and resolver routes.
