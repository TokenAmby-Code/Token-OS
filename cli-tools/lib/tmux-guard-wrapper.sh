...
410 GONE: cli-tools/lib/tmux-guard-wrapper.sh (tmux-guard-wrapper.sh) is tombstoned by the 2026-06-30 tmux CLI exterminatus.
...
PY
    ...
    # Resolve Imperium stable pane ids (1:N, palace:N, council:custodes) once,
